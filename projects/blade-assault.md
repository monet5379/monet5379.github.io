...
스테이지 수명과 방 안 전투 루프·목표·진행 플래그를 나눴습니다. Room은 언제 싸우는가이고, [액션 척추](#액션-척추)는 한 프레임에 무엇을 시도하는가입니다.
...
- **개선**: 그 경계를 레이아웃 계약으로만 뽑아 [세이브 레이아웃]({{ "/projects/save-layout/" | relative_url }})으로 정리했습니다.
  - [세이브 레이아웃 1/2 Main·Side·Meta로 나눈 이유]({{ "/notes/save-layout-boundaries/" | relative_url }})
  - [세이브 레이아웃 2/2 슬롯 백업 대신 Side 레인을 둔 이유]({{ "/notes/save-layout-side-lane/" | relative_url }})
