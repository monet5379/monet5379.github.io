...
[드래곤 이즈 데드 (프로젝트)]({{ "/projects/dragon-is-dead/" | relative_url }}) 다국어 TMP 작업에서 어떤 글자가 아틀라스에 있는가와 언제 처음 그리는가를 나눈 경험을, `Assets/TmpFontPipeline` 통째 복사로 재현·검증할 수 있게 정리했습니다.
...
- 연관: [드래곤 이즈 데드 (프로젝트)]({{ "/projects/dragon-is-dead/" | relative_url }}) · [TMP Static 아틀라스로 Dynamic hitch 피하기 (노트)]({{ "/notes/tmp-static-font-atlas/" | relative_url }}) · [스플래시·옵션으로 옮긴 TMP 폰트 워밍업 (노트)]({{ "/notes/tmp-font-warmup/" | relative_url }})
...
- 드래곤 이즈 데드·타이틀 본편 로컬라이즈 프레임워크가 아닙니다.
...
| 프로젝트 | TMP에서 가져온 / 남긴 것 |
|----------|---------------------------|
| [드래곤 이즈 데드 (프로젝트)]({{ "/projects/dragon-is-dead/" | relative_url }}) | Static extract · Dialogue 버킷 · Splash/옵션 warmup · supersede |
